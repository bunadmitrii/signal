...
sound_device_config_t *config_allocate(){
    return malloc(sizeof(sound_device_config_t));
}

void config_free(sound_device_config_t* sound_device_config_ptr){
...
ssize_t get_frame_size(sound_device_config_t * config){
    ssize_t frame_size;
